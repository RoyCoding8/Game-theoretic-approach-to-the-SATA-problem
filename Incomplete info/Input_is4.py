...
# Worker Skills
df = pd.read_csv(r'.\Effect_of_skills_of_incomp_workers\5_skills\worker_skills.csv')
...
df = pd.read_csv(r'.\Effect_of_skills_of_incomp_workers\5_skills\worker_skills_incomplete.csv')
