...
# Worker Skills
df = pd.read_csv(r'.\Effect_of_no_of_incomp_workers\2_incomp_workers\worker_skills.csv')
...
df = pd.read_csv(r'.\Effect_of_no_of_incomp_workers\2_incomp_workers\worker_skills_incomplete.csv')
s = 2       # No of workers with incomplete info about skills
