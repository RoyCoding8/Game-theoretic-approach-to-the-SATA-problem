...
# Worker Skills
df = pd.read_csv(r'.\Effect_of_no_of_incomp_workers\1_incomp_worker\worker_skills.csv')
...
df = pd.read_csv(r'.\Effect_of_no_of_incomp_workers\1_incomp_worker\worker_skills_incomplete.csv')
s = 1       # No of workers with incomplete info about skills
