...
df = pd.read_csv(r'.\Effect_of_tasks\300_tasks\task_budget.csv')
n=len(df)
...
# Task Location
df = pd.read_csv(r'.\Effect_of_tasks\300_tasks\task_location.csv')
...
df = pd.read_csv(r'.\Effect_of_tasks\300_tasks\task_skills.csv')
